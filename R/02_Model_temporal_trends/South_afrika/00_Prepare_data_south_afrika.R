...
# subset the data to the South Africa region
vec_dataset_South <-
  readr::read_rds(
    here::here(
...
if (
  ...
  message(
    paste0(
      ...
      length(unique(data_to_fit_South_afrika$series))
    )
  )
  
  summary(data_to_fit_South_afrika) %>%
    print()
